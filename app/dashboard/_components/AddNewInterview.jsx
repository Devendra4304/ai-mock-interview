...
function AddNewInterview() {
  ...
  return (
    <div>
      <div
        className="p-10 border rounded-lg text-center bg-secondary hover:scale-105 hover:shadow-md cursor-pointer transition-all"
              ...
              <form onSubmit={onSubmit}>
                <div>
                  ...
                  <div className="my-3">
                    ...
                    <Textarea
                      placeholder="Ex. ReactJs, NextJs, NodeJs, MySql, Kotlin"
                      required

...
function Interview({params}) {
  ...
  return (
    <div className='my-10'>
      ...
      <h2 className='flex gap-2 items-center'><Lightbulb/><span className='font-bold'>Information</span></h2>
        <h2 className='mt-3'>{process.env.NEXT_PUBLIC_INFORAMTION}</h2>
      </div>
      </div>

      <div>
       {webCamEnabled? <Webcam 
        onUserMedia={()=>setInterviewData(true)}
